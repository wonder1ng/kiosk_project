...
public class HtmlController {
    ...
    @ResponseBody
    public String loginAction(@Valid @ModelAttribute UserLoginDto dto,
        ...
        Optional<UserEntity> optional2 =
                userRepository.findByUserIdAndUserPw(dto.getUserId(), dto.getUserPw());
    ...
    public String joinAction(@Valid @ModelAttribute UserRegisterDto dto,
        ...
        try {
            UserEntity entity = dto.toSaveEntity();
